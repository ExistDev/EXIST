...
public class GuiChangeLog extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		if (mc.gameSettings.guiScale == 0) {
			// Auto
			Exist.fontRenderer.fontRenderer50.drawStringWithShadow("ChangeLog", this.width / 5 + 120, height / 5 - 50,
					0xFFFFFFFF);
		} else if (mc.gameSettings.guiScale == 1) {
			// Small
			Exist.fontRenderer.fontRenderer50.drawStringWithShadow("ChangeLog", this.width / 5 + 210, height / 5 - 50,
					0xFFFFFFFF);
		} else if (mc.gameSettings.guiScale == 2) {
			// Normal
			Exist.fontRenderer.fontRenderer50.drawStringWithShadow("ChangeLog", this.width / 5 + 245, height / 5 - 50,
					0xFFFFFFFF);
		} else if (mc.gameSettings.guiScale == 3) {
			// Large
			Exist.fontRenderer.fontRenderer50.drawStringWithShadow("ChangeLog", this.width / 5 + 165, height / 5 - 50,
					0xFFFFFFFF);
