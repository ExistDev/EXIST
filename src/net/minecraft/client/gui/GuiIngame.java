...
public class GuiIngame extends Gui {
	...
	public void func_175180_a(float p_175180_1_) {
		...
		EventRender2D render2D = new EventRender2D(var3, var4);
		EventManager.call(render2D);
	...
	protected void func_180479_a(ScaledResolution p_180479_1_, float p_180479_2_) {
		if (this.mc.func_175606_aa() instanceof EntityPlayer) {
			...
			for (int var6 = 0; var6 < 9; ++var6) {
				...
				this.func_175184_a(var6, var7 - 1, var8, p_180479_2_, var3);
			}
	...
	private void func_180475_a(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_) {
		...
		while (var12.hasNext()) {
			...
			me.existdev.exist.utils.helper.RenderHelper.drawRect(var25 - 2, var18, var19,
					var18 + this.func_175179_f().FONT_HEIGHT, 1342177280);
			...
			if (var11 == var21.size()) {
				...
				me.existdev.exist.utils.helper.RenderHelper.drawRect(var25 - 2,
						var18 - this.func_175179_f().FONT_HEIGHT - 1, var19, var18 - 1, 1610612736);
				me.existdev.exist.utils.helper.RenderHelper.drawRect(var25 - 2, var18 - 1, var19, var18, 1342177280);
