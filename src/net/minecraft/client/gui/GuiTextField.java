...
import me.existdev.exist.font.NormalFontManager;
...
public class GuiTextField extends Gui {
	...
	private final NormalFontManager fontRendererInstance;
	...
	public GuiTextField(int p_i45542_1_, NormalFontManager p_i45542_2_, int p_i45542_3_, int p_i45542_4_,
	...
	public void mouseClicked(int p_146192_1_, int p_146192_2_, int p_146192_3_) {
		...
		if (this.isFocused && var4 && p_146192_3_ == 0) {
			...
			String var6 = Exist.fontRenderer.helveticaChat.trimStringToWidth(this.text.substring(this.lineScrollOffset),
					this.getWidth());
			this.setCursorPosition(
					Exist.fontRenderer.helveticaChat.trimStringToWidth(var6, var5).length() + this.lineScrollOffset);
		}
	}
	...
	public void drawTextBox() {
		if (this.getVisible()) {
			if (this.getEnableBackgroundDrawing()) {
				RenderHelper.drawRect(this.xPosition - 1, this.yPosition - 1, this.xPosition + this.width + 1,
						this.yPosition + this.height + 1, 0x40FFFFFF);
				RenderHelper.drawRect(this.xPosition, this.yPosition, this.xPosition + this.width,
						this.yPosition + this.height, 0x40FFFFFF);
			}
			...
			String var4 = Exist.fontRenderer.helveticaChat.trimStringToWidth(this.text.substring(this.lineScrollOffset),
					this.getWidth());
			...
			if (var4.length() > 0) {
				...
				var9 = Exist.fontRenderer.helveticaChat.drawStringWithShadow(var10, (float) var7, (float) var8 - 1,
						var1);
			}
			...
			if (var4.length() > 0 && var5 && var2 < var4.length()) {
				var9 = Exist.fontRenderer.helveticaChat.drawStringWithShadow(var4.substring(var2), (float) var9,
						(float) var8, var1);
			}

			if (var6) {
				if (var13) {
					RenderHelper.drawRect(var11, var8 - 1, var11 + 1,
							var8 + 1 + Exist.fontRenderer.helveticaChat.FONT_HEIGHT, 0x40FFFFFF);
				} else {
					Exist.fontRenderer.helveticaChat.drawStringWithShadow("_", (float) var11, (float) var8 - 1, var1);
				}
			}

			if (var3 != var2) {
				int var12 = var7 + Exist.fontRenderer.helveticaChat.getStringWidth(var4.substring(0, var3));
				this.drawCursorVertical(var11, var8 - 1, var12 - 1,
						var8 + 1 + Exist.fontRenderer.helveticaChat.FONT_HEIGHT);
			}
		}
	}
	...
	public void setSelectionPos(int p_146199_1_) {
		...
		if (Exist.fontRenderer.helveticaChat != null) {
			...
			if (p_146199_1_ == this.lineScrollOffset) {
				this.lineScrollOffset -= Exist.fontRenderer.helveticaChat.trimStringToWidth(this.text, var3, true)
						.length();
			}
