...
public class GuiChat extends GuiScreen {
	...
	public void initGui() {
		...
		this.inputField = new GuiTextField(0, Exist.fontRenderer.helveticaTextField, 4, this.height - 12,
				this.width - 4, 12);
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		RenderHelper.drawRect(2, this.height - 14, this.width - 2, this.height - 2, 0x40FFFFFF);
