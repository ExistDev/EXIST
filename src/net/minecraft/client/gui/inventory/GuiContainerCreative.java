...
public class GuiContainerCreative extends InventoryEffectRenderer
{
    ...
    public void initGui()
    {
        if (this.mc.playerController.isInCreativeMode())
        {
            ...
            this.searchField = new GuiTextField(0, Exist.fontRenderer.helveticaTextField, this.guiLeft + 82, this.guiTop + 6, 89, Exist.fontRenderer.helveticaTextField.FONT_HEIGHT);
