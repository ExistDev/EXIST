...
public class EntityRenderer implements IResourceManagerReloadListener {
	...
	private void setupViewBobbing(float p_78475_1_) {
		if (this.mc.func_175606_aa() instanceof EntityPlayer) {
			...
			if (Exist.getModules(NoBob.class).isToggled()) {
				var2.distanceWalkedModified = 0;
			}
			...
			if (!this.mc.gameSettings.debugCamEnable) {
				...
				if (Reflector.ForgeHooksClient_orientBedCamera.exists()) {
					Reflector.callVoid(Reflector.ForgeHooksClient_orientBedCamera,
							new Object[] { this.mc.theWorld, var27, var11, var2 });
				...
				if (this.mc.objectMouseOver != null
					...
					if (this.mc.playerController.func_178889_l() == WorldSettings.GameType.SPECTATOR) {
						...
						if (Reflector.ForgeBlock_hasTileEntity.exists()) {
							...
							hasTileEntity = Reflector.callBoolean(var5, Reflector.ForgeBlock_hasTileEntity,
									new Object[] { bs });
						} else {
	...
	private void func_175068_a(int pass, float partialTicks, long finishTimeNano) {
		...
		if (Exist.getModules(Fullbright.class).isToggled()) {
			mc.gameSettings.gammaSetting = 100F;
		}

		// ChestESP
		if (Exist.getModules(ChestESP.class).isToggled()) {
			Object o;
			Iterator var3;
			TileEntityChest chest;
			if (Exist.settingManager.getSetting(Exist.getModules(ChestESP.class), "Mode").getCurrentOption()
				...
				while (var3.hasNext()) {
					...
					if (o instanceof TileEntityChest) {
						...
						RenderGlobal var10000 = mc.renderGlobal;
						RenderGlobal.drawOutlinedBoundingBox(new AxisAlignedBB((double) chest.getPos().getX() - 0.25D,
								(double) chest.getPos().getY(), (double) chest.getPos().getZ() - 0.25D,
								(double) chest.getPos().getX() + 0.25D, (double) chest.getPos().getY() + 0.5D,
								(double) chest.getPos().getZ() + 0.25D), 1);
					}
				}
			} else {
				var3 = mc.theWorld.loadedTileEntityList.iterator();
				...
				RenderManager var10002;
				RenderManager var10003;
				double var62;
				double var72;
				double var82;
				while (var3.hasNext()) {
					...
					if (o instanceof TileEntityChest) {
						chest = (TileEntityChest) o;
						GlStateManager.pushMatrix();
						var62 = (double) ((float) chest.getPos().getX());
						var10001 = mc.renderManager;
						var62 = var62 - RenderManager.renderPosX + 0.5D;
						var72 = (double) chest.getPos().getY();
						var10002 = mc.renderManager;
						var72 = var72 - RenderManager.renderPosY + 0.5D;
						var82 = (double) chest.getPos().getZ();
						var10003 = mc.renderManager;
						GlStateManager.translate(var62, var72, var82 - RenderManager.renderPosZ + 0.5D);
						...
						if (Exist.settingManager.getSetting(Exist.getModules(ChestESP.class), "Mode").getCurrentOption()
							...
							Gui.drawRect(-23.0D, -23.0D, 23.0D, -18.0D, -16777216);
							Gui.drawRect(-23.0D, 21.0D, 23.0D, 26.0D, -16777216);
							Gui.drawRect(18.0D, 25.0D, 23.0D, -22.0D, -16777216);
							Gui.drawRect(-18.0D, 25.0D, -23.0D, -22.0D, -16777216);
							Gui.drawRect(-22.0D, -22.0D, 22.0D, -19.0D, 0xFF00FF00);
							Gui.drawRect(-22.0D, 22.0D, 22.0D, 25.0D, 0xFF00FF00);
							Gui.drawRect(19.0D, 22.0D, 22.0D, -19.0D, 0xFF00FF00);
							Gui.drawRect(-19.0D, 22.0D, -22.0D, -19.0D, 0xFF00FF00);
						}
						...
						if (Exist.settingManager.getSetting(Exist.getModules(ChestESP.class), "Mode").getCurrentOption()
							...
							Gui.drawRect(-18.0D, 25.0D, -23.0D, 9.0D, -16777216);
							Gui.drawRect(-18.0D, -23.0D, -23.0D, -6.0D, -16777216);
							Gui.drawRect(-22.0D, -22.0D, -7.0D, -19.0D, 0xFF00FF00);
							Gui.drawRect(-22.0D, 22.0D, -7.0D, 25.0D, 0xFF00FF00);
							Gui.drawRect(19.0D, -22.0D, 22.0D, -7.0D, 0xFF00FF00);
							Gui.drawRect(-19.0D, 22.0D, -22.0D, 10.0D, 0xFF00FF00);
							Gui.drawRect(22.0D, 22.0D, 7.0D, 25.0D, 0xFF00FF00);
							Gui.drawRect(22.0D, -22.0D, 7.0D, -19.0D, 0xFF00FF00);
							Gui.drawRect(19.0D, 22.0D, 22.0D, 10.0D, 0xFF00FF00);
							Gui.drawRect(-19.0D, -22.0D, -22.0D, -7.0D, 0xFF00FF00);
				...
				while (var3.hasNext()) {
					...
					if (o instanceof TileEntityEnderChest) {
						...
						GlStateManager.pushMatrix();
						var62 = (double) ((float) echest.getPos().getX());
						var10001 = mc.renderManager;
						var62 = var62 - RenderManager.renderPosX + 0.5D;
						var72 = (double) echest.getPos().getY();
						var10002 = mc.renderManager;
						var72 = var72 - RenderManager.renderPosY + 0.5D;
						var82 = (double) echest.getPos().getZ();
						var10003 = mc.renderManager;
						GlStateManager.translate(var62, var72, var82 - RenderManager.renderPosZ + 0.5D);
						GlStateManager.rotate(-Minecraft.getMinecraft().renderManager.playerViewY, 0.0F, 1.0F, 0.0F);
						GlStateManager.scale(-0.02666667F, -0.02666667F, 0.02666667F);
						...
						if (Exist.settingManager.getSetting(Exist.getModules(ChestESP.class), "Mode").getCurrentOption()
							...
							Gui.drawRect(18.0D, 25.0D, 23.0D, -22.0D, -16777216);
							Gui.drawRect(-18.0D, 25.0D, -23.0D, -22.0D, -16777216);
							Gui.drawRect(-22.0D, -22.0D, 22.0D, -19.0D, -3405571);
							Gui.drawRect(-22.0D, 22.0D, 22.0D, 25.0D, -3405571);
							Gui.drawRect(19.0D, 22.0D, 22.0D, -19.0D, -3405571);
							Gui.drawRect(-19.0D, 22.0D, -22.0D, -19.0D, -3405571);
						}
						...
						if (Exist.settingManager.getSetting(Exist.getModules(ChestESP.class), "Mode").getCurrentOption()
							...
							Gui.drawRect(-18.0D, 25.0D, -23.0D, 9.0D, -16777216);
							Gui.drawRect(-18.0D, -23.0D, -23.0D, -6.0D, -16777216);
							Gui.drawRect(-22.0D, -22.0D, -7.0D, -19.0D, -3405571);
							Gui.drawRect(-22.0D, 22.0D, -7.0D, 25.0D, -3405571);
							Gui.drawRect(19.0D, -22.0D, 22.0D, -7.0D, -3405571);
							Gui.drawRect(-19.0D, 22.0D, -22.0D, 10.0D, -3405571);
							Gui.drawRect(22.0D, 22.0D, 7.0D, 25.0D, -3405571);
							Gui.drawRect(22.0D, -22.0D, 7.0D, -19.0D, -3405571);
							Gui.drawRect(19.0D, 22.0D, 22.0D, 10.0D, -3405571);
							Gui.drawRect(-19.0D, -22.0D, -22.0D, -7.0D, -3405571);
		...
		if (Exist.getModules(ESP.class).isToggled()) {
			playerESP();
		}
		...
		handRendered = Reflector.callBoolean(Reflector.ForgeHooksClient_renderFirstPersonHand,
	...
	public void playerESP() {
		...
		while (true) {
			...
			GlStateManager.pushMatrix();
			double var10000 = (double) ((float) entity.lastTickPosX)
					+ (entity.posX - entity.lastTickPosX) * (double) Minecraft.getMinecraft().timer.renderPartialTicks;
			RenderManager var10001 = Minecraft.getMinecraft().renderManager;
			var10000 -= RenderManager.renderPosX;
			double var5 = entity.lastTickPosY
					+ (entity.posY - entity.lastTickPosY) * (double) Minecraft.getMinecraft().timer.renderPartialTicks;
			RenderManager var10002 = Minecraft.getMinecraft().renderManager;
			var5 -= RenderManager.renderPosY;
			double var6 = entity.lastTickPosZ
					+ (entity.posZ - entity.lastTickPosZ) * (double) Minecraft.getMinecraft().timer.renderPartialTicks;
			RenderManager var10003 = Minecraft.getMinecraft().renderManager;
			GlStateManager.translate(var10000, var5, var6 - RenderManager.renderPosZ);
			GlStateManager.rotate(-Minecraft.getMinecraft().renderManager.playerViewY, 0.0F, 1.0F, 0.0F);
			GlStateManager.scale(-0.02666667F, -0.02666667F, 0.02666667F);
			GlStateManager.disableDepth();
			GlStateManager.disableLighting();
			if (Exist.settingManager.getSetting(Exist.getModules(ESP.class), "Mode").getCurrentOption()
				...
				if (entity.hurtTime != 0) {
					Gui.drawRect(31.0D, -79.0D, 26.0D, -54.0D, -16777216);
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(-31.0D, -79.0D, -26.0D, -54.0D, -16777216);
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(31.0D, -11.0D, 26.0D, 11.0D, -16777216);
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(-31.0D, -11.0D, -26.0D, 11.0D, -16777216);
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(-30.0D, 6.0D, -9.0D, 11.0D, -16777216);
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(-30.0D, -79.0D, -9.0D, -74.0D, -16777216);
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(30.0D, 6.0D, 9.0D, 11.0D, -16777216);
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(30.0D, -79.0D, 9.0D, -74.0D, -16777216);
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(30.0D, -75.0D, 27.0D, -55.0D, (new Color(255, 0, 0)).getRGB());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(-30.0D, -75.0D, -27.0D, -55.0D, (new Color(255, 0, 0)).getRGB());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(30.0D, -10.0D, 27.0D, 10.0D, (new Color(255, 0, 0)).getRGB());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(-30.0D, -10.0D, -27.0D, 10.0D, (new Color(255, 0, 0)).getRGB());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(-30.0D, 7.0D, -10.0D, 10.0D, (new Color(255, 0, 0)).getRGB());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(-30.0D, -78.0D, -10.0D, -75.0D, (new Color(255, 0, 0)).getRGB());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(30.0D, 7.0D, 10.0D, 10.0D, (new Color(255, 0, 0)).getRGB());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(30.0D, -78.0D, 10.0D, -75.0D, (new Color(255, 0, 0)).getRGB());
					...
					Gui.drawRect(30.0D, -79.0D, 9.0D, -74.0D, -16777216);
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(30.0D, -75.0D, 27.0D, -55.0D, Exist.getClientColor());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(-30.0D, -75.0D, -27.0D, -55.0D, Exist.getClientColor());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(30.0D, -10.0D, 27.0D, 10.0D, Exist.getClientColor());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(-30.0D, -10.0D, -27.0D, 10.0D, Exist.getClientColor());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(-30.0D, 7.0D, -10.0D, 10.0D, Exist.getClientColor());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(-30.0D, -78.0D, -10.0D, -75.0D, Exist.getClientColor());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(30.0D, 7.0D, 10.0D, 10.0D, Exist.getClientColor());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(30.0D, -78.0D, 10.0D, -75.0D, Exist.getClientColor());
			...
			if (Exist.settingManager.getSetting(Exist.getModules(ESP.class), "Mode").getCurrentOption()
				...
				if (entity.hurtTime != 0) {
					...
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(30.0D, -75.0D, 27.0D, 10.0D, (new Color(255, 0, 0)).getRGB());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(-30.0D, -75.0D, -27.0D, 10.0D, (new Color(255, 0, 0)).getRGB());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(-30.0D, 7.0D, 30.0D, 10.0D, (new Color(255, 0, 0)).getRGB());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(-30.0D, -78.0D, 30.0D, -75.0D, (new Color(255, 0, 0)).getRGB());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
				} else {
					Gui.drawRect(31.0D, -79.0D, 26.0D, 11.0D, -16777216);
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					...
					Gui.drawRect(-30.0D, -79.0D, 30.0D, -74.0D, -16777216);
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(30.0D, -75.0D, 27.0D, 10.0D, Exist.getClientColor());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(-30.0D, -75.0D, -27.0D, 10.0D, Exist.getClientColor());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(-30.0D, 7.0D, 30.0D, 10.0D, Exist.getClientColor());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(-30.0D, -78.0D, 30.0D, -75.0D, Exist.getClientColor());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
				}
			}
			...
			if (Exist.settingManager.getSetting(Exist.getModules(ESP.class), "Mode").getCurrentOption()
				...
				if (entity.hurtTime != 0) {
					Gui.drawRect(28.0D, -75.0D, 27.0D, 8.0D, (new Color(255, 0, 0)).getRGB());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(-28.0D, -75.0D, -27.0D, 8.0D, (new Color(255, 0, 0)).getRGB());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(-28.0D, 7.0D, 28.0D, 8.0D, (new Color(255, 0, 0)).getRGB());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(-28.0D, -76.0D, 28.0D, -75.0D, (new Color(255, 0, 0)).getRGB());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
				} else {
					Gui.drawRect(28.0D, -75.0D, 27.0D, 8.0D, Exist.getClientColor());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(-28.0D, -75.0D, -27.0D, 8.0D, Exist.getClientColor());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(-28.0D, 7.0D, 28.0D, 8.0D, Exist.getClientColor());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(-28.0D, -76.0D, 28.0D, -75.0D, Exist.getClientColor());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
				}
			}
	...
	private void frameInit() {
		...
		if (world != null) {
			...
			if (Config.isNotify64BitJava()) {
				...
				ChatComponentText msg2 = new ChatComponentText(
