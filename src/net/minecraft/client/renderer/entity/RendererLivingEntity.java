...
import me.existdev.exist.utils.OutlineUtils;
...
public abstract class RendererLivingEntity extends Render {
	...
	public void doRender(EntityLivingBase p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_,
		...
		Chams esp = (Chams) Exist.getModules(Chams.class);
		boolean renderChams = esp.isValidTarget(p_76986_1_) && esp.isToggled();
		if (renderChams) {
			GL11.glEnable(32823);
		...
		if (!Reflector.RenderLivingEvent_Pre_Constructor.exists()
			...
			if (Config.isShaders() && Shaders.useEntityHurtFlash) {
				Shaders.setEntityHurtFlash(p_76986_1_.hurtTime <= 0 && p_76986_1_.deathTime <= 0 ? 0 : 102,
	...
	protected void renderModel(EntityLivingBase p_77036_1_, float p_77036_2_, float p_77036_3_, float p_77036_4_,
		...
		if (var8 || var9) {
			...
			if (Exist.getModules(ESP.class).isToggled() && Exist.settingManager
					.getSetting(Exist.getModules(ESP.class), "Mode").getCurrentOption().equalsIgnoreCase("Outline")) {
				if (p_77036_1_ instanceof EntityPlayer && p_77036_1_ != Minecraft.getMinecraft().thePlayer) {
					Color n = Color.WHITE;
					OutlineUtils.setColor(n);
					mainModel.render(p_77036_1_, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_,
							p_77036_7_);
					OutlineUtils.renderOne(1.0F);
					mainModel.render(p_77036_1_, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_,
							p_77036_7_);
