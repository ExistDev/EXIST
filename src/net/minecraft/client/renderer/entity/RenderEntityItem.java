...
public class RenderEntityItem extends Render {
	...
	public void func_177075_a(EntityItem p_177075_1_, double p_177075_2_, double p_177075_4_, double p_177075_6_,
			float p_177075_8_, float p_177075_9_) {
		ItemStack var10 = p_177075_1_.getEntityItem();
		this.field_177079_e.setSeed(187L);
		boolean var11 = false;
		Chams esp = (Chams) Exist.getModules(Chams.class);
		boolean renderChams = esp.isValidTarget(p_177075_1_) && esp.isToggled();
		if (renderChams) {
			GL11.glEnable(32823);
