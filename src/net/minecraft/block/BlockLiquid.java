...
public abstract class BlockLiquid extends Block {
	...
	protected int func_176362_e(IBlockAccess p_176362_1_, BlockPos p_176362_2_) {
		return p_176362_1_.getBlockState(p_176362_2_).getBlock().getMaterial() == this.blockMaterial
				? ((Integer) p_176362_1_.getBlockState(p_176362_2_).getValue(LEVEL)).intValue() : -1;
	}
	...
	public AxisAlignedBB getCollisionBoundingBox(World worldIn, BlockPos pos, IBlockState state) {
		...
		if (Exist.getModules(Jesus.class).isToggled() && Exist.settingManager
				.getSetting(Exist.getModules(Jesus.class), "Mode").getCurrentOption().equalsIgnoreCase("Solid")
				&& (mc.thePlayer.fallDistance < 4.0F)) {
			if (mc.gameSettings.keyBindSneak.pressed || this.isInLiquid()) {
				return null;
			}
